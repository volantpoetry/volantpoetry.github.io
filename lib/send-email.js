// ============================================================
// FILE: lib/send-email.js  (volantpoetry.vercel.app)
// ============================================================
// Best-effort notification emails via Resend (free tier). No email
// is sent and no error is thrown if RESEND_API_KEY is not configured —
// the feature degrades gracefully to in-app notifications only.
// Mirrors store1/lib/send-email.js so both projects stay identical.
// ============================================================
