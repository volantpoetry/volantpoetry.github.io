// ============================================================
// FILE: api/notify-activity.js  (volantpoetry.vercel.app)
// ============================================================
// Activity notification emails for comments, replies, contact
// inquiries and direct messages. Mirrored identically in
// store1/api/notify-activity.js (volantreads.vercel.app) so both
// projects can call the same relative /api/notify-activity path.
//
